...
class RelationModule(torch.nn.Module):
    # this is the naive implementation of the n-frame relation module,
    # as num_frames == num_frames_relation
...
class RelationModuleMultiScale(torch.nn.Module):
    # Temporal Relation module in multiply scale,
    # suming over [2-frame relation, 3-frame relation, ..., n-frame relation]
